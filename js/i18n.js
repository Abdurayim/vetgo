...
const TRANSLATIONS = {
  en: {
    ...
    "reg.login": "Log in",
    "reg.needLocation": "Please set your location using the button above.",
    "reg.creating": "Creating…",

    "loc.set": "✓ Location set ({lat}, {lng})",
    "loc.updated": "✓ Updated to {lat}, {lng}",
    "loc.denied": "Location denied — please allow it to continue",
    "loc.deniedShort": "Location denied",
    "loc.failed": "Couldn't get location, try again",
    "loc.failedShort": "Couldn't get location",
  ...
  ru: {
    ...
    "reg.login": "Войти",
    "reg.needLocation": "Укажите местоположение с помощью кнопки выше.",
    "reg.creating": "Создание…",

    "loc.set": "✓ Местоположение задано ({lat}, {lng})",
    "loc.updated": "✓ Обновлено: {lat}, {lng}",
    "loc.denied": "Доступ к геолокации запрещён — разрешите, чтобы продолжить",
    "loc.deniedShort": "Доступ запрещён",
    "loc.failed": "Не удалось определить местоположение, повторите",
    "loc.failedShort": "Не удалось определить местоположение",
  ...
  uz: {
    ...
    "reg.login": "Kirish",
    "reg.needLocation": "Yuqoridagi tugma orqali joylashuvingizni belgilang.",
    "reg.creating": "Yaratilmoqda…",

    "loc.set": "✓ Joylashuv belgilandi ({lat}, {lng})",
    "loc.updated": "✓ Yangilandi: {lat}, {lng}",
    "loc.denied": "Joylashuvga ruxsat berilmadi — davom etish uchun ruxsat bering",
    "loc.deniedShort": "Ruxsat berilmadi",
    "loc.failed": "Joylashuvni aniqlab bo‘lmadi, qayta urinib ko‘ring",
    "loc.failedShort": "Joylashuvni aniqlab bo‘lmadi",
