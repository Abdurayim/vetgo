...
const TRANSLATIONS = {
  en: {
    ...
    "home.banner.approx": "We couldn't get your exact location, so vets are sorted by distance from {city}.",
    "home.banner.approxNoCity": "We couldn't get your exact location, so vets are sorted by distance from your approximate area.",
    ...
    "loc.found": "✓ Found you ({acc}). Drag the pin if your clinic is somewhere else.",
    "loc.foundRough": "Found you roughly ({acc}). Check the pin and drag it to your clinic.",
    "loc.approx": "We placed you near {city} because your exact position isn't available. Drag the pin to your clinic.",
    "loc.approxNoCity": "We placed you approximately because your exact position isn't available. Drag the pin to your clinic.",
    "loc.inApp": "For your exact position, open this page in Chrome or Safari — in-app browsers often block location.",
  ...
  ru: {
    ...
    "home.banner.approx": "Не удалось определить точное местоположение, поэтому ветеринары отсортированы по расстоянию от: {city}.",
    "home.banner.approxNoCity": "Не удалось определить точное местоположение, поэтому ветеринары отсортированы по расстоянию от вашего примерного района.",
    ...
    "loc.finding": "Определяем ваше местоположение…",
    "loc.found": "✓ Нашли вас ({acc}). Перетащите метку, если клиника в другом месте.",
    "loc.foundRough": "Нашли вас приблизительно ({acc}). Проверьте метку и перетащите её на место клиники.",
    "loc.approx": "Мы отметили вас примерно — {city}, потому что точное местоположение недоступно. Перетащите метку на место клиники.",
    "loc.approxNoCity": "Мы отметили вас примерно, потому что точное местоположение недоступно. Перетащите метку на место клиники.",
    "loc.inApp": "Чтобы определить точное местоположение, откройте страницу в Chrome или Safari — встроенные браузеры приложений часто его блокируют.",
  ...
  uz: {
    ...
    "home.banner.approx": "Aniq joylashuvingizni aniqlab bo‘lmadi, shuning uchun veterinarlar {city} shahridan masofa bo‘yicha saralandi.",
    "home.banner.approxNoCity": "Aniq joylashuvingizni aniqlab bo‘lmadi, shuning uchun veterinarlar taxminiy hududingizdan masofa bo‘yicha saralandi.",
    ...
    "loc.finding": "Joylashuvingiz aniqlanmoqda…",
    "loc.found": "✓ Joylashuvingiz topildi ({acc}). Klinikangiz boshqa joyda bo‘lsa, belgini suring.",
    "loc.foundRough": "Joylashuvingiz taxminan topildi ({acc}). Belgini tekshirib, klinikangiz joyiga suring.",
    "loc.approx": "Aniq joylashuv mavjud emasligi sababli sizni taxminan {city} atrofida belgiladik. Belgini klinikangiz joyiga suring.",
    "loc.approxNoCity": "Aniq joylashuv mavjud emasligi sababli sizni taxminan belgiladik. Belgini klinikangiz joyiga suring.",
    "loc.inApp": "Aniq joylashuv uchun sahifani Chrome yoki Safari’da oching — ilovalar ichidagi brauzerlar ko‘pincha joylashuvni bloklaydi.",
